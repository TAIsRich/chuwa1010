...
public class StreamApiTest {
    ...
    public void exercise2() {
        ...
        List<Order> result = orderRepo.findAll()
                .stream()
                .filter(order -> order.getProducts().stream().anyMatch(product -> product.getCategory().equals("Baby"))).collect(Collectors.toList());
    ...
    public void exercise3() {
        ...
        List<Product> result = productRepo.findAll()
                ...
                .map(product -> {
                    product.withPrice(product.getPrice() * 0.9);
                    return product;
                })
                .collect(Collectors.toList());
    ...
    public void exercise4() {
        ...
        List<Product> result = orderRepo.findAll()
                ...
                .filter(order -> order.getDeliveryDate().compareTo(LocalDate.of(2021, 4,1)) <= 0)
