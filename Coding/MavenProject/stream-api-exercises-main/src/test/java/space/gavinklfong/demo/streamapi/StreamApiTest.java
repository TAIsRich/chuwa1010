...
//				.stream()
//				.filter(p -> p.getCategory().equalsIgnoreCase("Books"))
//				.peek(p -> System.out.println("Peek test: " + productRepo.toString()))
//				.min(Comparator.comparing(Product::getPrice));
	...
	public void exercise10() {
		...
		System.out.println("Ex 10" + statistics.toString());
	...
	public void exercise11() {
		...
		System.out.println("Ex 11" + result);
	...
	public void exercise13() {
		...
		System.out.println("Ex13: " + result);
