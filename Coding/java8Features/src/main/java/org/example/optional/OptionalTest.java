...
public class OptionalTest {
     ...
     * of(T t) - 不可以为null, 如果为null会有exception,  return type:Optional
     * ofNullable(T t) - 可以为null, return type Optional
     * orElse(T t) - 如果当前的optional内部封装的t是非空的，则返回内部t, 如果内部的t是空的， 则返回orElse()方法中的t, return type T
     */
