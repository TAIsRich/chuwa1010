...
public class Lvl {
    ...
    //when the vehicle leaves the parking lot, the number of available slot increase by 1
    public void slotFreed(){
        availableSlots = availableSlots+1;
        System.out.println("Available Slots int he current level:" + availableSlots);
    }
}
