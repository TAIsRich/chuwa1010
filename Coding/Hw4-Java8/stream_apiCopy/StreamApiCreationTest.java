package com.chuwa.tutorial.t06_java8.features.stream_apiCopy;
...
public class StreamApiCreationTest {
    ...
    public void testCollection(){
        ...
        System.out.println("System object:  "+ stream);

        //返回一个并行流
        Stream<Integer> parallelStream = col.parallelStream();
        System.out.println("Paralletl stream object:    "+ parallelStream);
    }
    ...
    @Test
    public void testOf(){
        Stream<Integer> stream= Stream.of(1,3,6,4,5);
        System.out.println("Stream object:    "+ stream);
    }
