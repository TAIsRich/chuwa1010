...
//        Post post = postRepository.findById(id).get();
    ...
    public List<PostDto> getAllPostWithJPQL() {
        return postJPQLRepository.getAllPostsWithJPQL().stream().map(post -> mapToDTO(post)).collect(Collectors.toList());
    }

    @Override
    public PostDto getPostByIdJPQLIndexParameter(Long id, String title) {
        Post post = postRepository.getPostByIdOrTitleJPQLIndexParameters(id, title);
        return mapToDTO(post);
    }

    @Override
    public PostDto getPostByIdJPQLNamedParameter(Long id, String title) {
        Post post = postRepository.getPostByIdOrTitleJPQLNamedParameters(id, title);
        return mapToDTO(post);
    }
