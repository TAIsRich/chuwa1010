...
//		List<Product> result = productRepo.findAll()
//				.stream()
//				.filter(product -> pricePredicate.and(pricePredicate).test(product))
//				.collect(Collectors.toList());
//
//		long startTime = System.currentTimeMillis();
//		long endTime = System.currentTimeMillis();
...
//		BiPredicate<Product,String> categoryBipre = ((product, s) -> product.getCategory().equalsIgnoreCase(s));
//		List<Product> result = productRepo.findAll()
//				.stream()
//				.filter(product -> categoryBipre.test(product,"Books") && product.getPrice()>100)
//				.collect(Collectors.toList());
//		long endTime = System.currentTimeMillis();
//
//
...
//				.peek(order -> order.getProducts().toString())
//				.flatMap(order -> order.getProducts().stream())
//				.distinct()
//				.collect(Collectors.toList());
//
